...
public class Robot {
    ...
    /**
     * Remembers all movements made by the current Robot
     */
     ...
     */
    final String cautiousMode = "DriveNormal";
    /**
     * The Roomba will continue to drive in dangerous situations
     */
    final String hazardousMode = "DriveAlways";
    String ip;
    final String infoURL = "http://" + ip + "/full_status.json";
    final String ceaseURL = "http://" + ip + "/command.json?command=drivestop";
    boolean cautious = true;
    /**
     * Remembers given commands.
     */
    String[] memory;
    String action = null;
    String result = null;
     ...
     *                <br>360 : spinleft
     */
    public void drive(double speed, double degrees) {
